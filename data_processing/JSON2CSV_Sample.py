...
def travFolder(filepath):
    ...
    for jf in jsonfiles:
        ...
        with open ("features.csv", 'a') as result_file:
            if len(values.split(',')) > 10:
                result_file.write(values[:-1] + ",\n")

if __name__ == '__main__':

    travFolder('./data/JSON_Folder/')
